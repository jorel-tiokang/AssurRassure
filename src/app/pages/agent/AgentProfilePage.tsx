...
import { Globe, Moon, Settings, User } from "lucide-react"
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        ...
        <p className="text-ink-muted mt-1">Gérez vos informations personnelles et vos préférences.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="md:col-span-1 border-transparent shadow-sm">
          <CardContent className="pt-6 flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h2 className="text-xl font-medium text-ink">Agent Admin</h2>
              <p className="text-sm text-ink-muted">agent@assurrassure.cm</p>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <Card className="border-transparent shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
                <User className="h-5 w-5 text-[#0055FF]" /> Informations Personnelles
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm">
              <p className="text-ink-muted">Les informations personnelles sont gérées par l'administrateur système.</p>
              <Button variant="outline">Demander une modification</Button>
            </CardContent>
          </Card>
        </div>
      </div>
